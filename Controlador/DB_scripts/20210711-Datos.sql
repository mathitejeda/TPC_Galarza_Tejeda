...
--Insertar ticket
GO
insert into ticket (idtecnico, Idcliente, idproducto, idestado, Problema, Diagnostico, Solucion, Fechaingreso,FechaEgreso, nroserie, IDservicio) values (NULL,12,1,1,'rotura cig�e�al',NULL,NULL,'2021-07-02',NULL,1000, 1)
